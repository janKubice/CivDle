...
public sealed class GameContent
{
    ...
    public GameContent WithGameplay(GameplayConfig gameplay) => new(
        ...
        Ambience, Terraform, Tutorial, Challenges, Contracts, Districts, SettlementRanks, Citizens, Neighbours, Elections, Milestones, Seasons, Faith, NpcCities, Vehicles, Mods);
